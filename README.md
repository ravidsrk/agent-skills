...
<p align="center">
  <img src="assets/banner.png" alt="Agent Skills — Infrastructure, Research, Creative" width="640">
</p>

<p align="center"><sub>↑ Banner generated by <code>terminal-poster</code>, one of the skills in this repo. We eat our own dog food.</sub></p>

```
   INFRASTRUCTURE            RESEARCH               CREATIVE
  ┌──────────────┐         ┌──────────────┐      ┌──────────────┐
  │   DNS +      │         │   8-source   │      │    viral     │
  │   AWS        │  ◀───▶  │   parallel   │ ◀──▶ │   posters    │
  │   migration  │         │   research   │      │    in 30s    │
  └──────────────┘         └──────────────┘      └──────────────┘
   cloudflare-dns           deep-research          terminal-poster
   namecheap-dns
