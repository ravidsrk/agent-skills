...
<p align="center">
  <img src="assets/banner.jpg" alt="benchmark-fleet" width="100%">
</p>

Orchestrate gstack benchmark under Orca against staging URLs for Core Web Vitals or load versus baseline.
...
ln -sfn "$(pwd)/agent-skills/skills/benchmark-fleet" ~/.claude/skills/benchmark-fleet
