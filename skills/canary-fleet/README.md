...
<p align="center">
  <img src="assets/banner.jpg" alt="canary-fleet" width="100%">
</p>

Orchestrate gstack canary post-deploy monitoring under Orca: health checks, error budget, alert artifacts.
...
ln -sfn "$(pwd)/agent-skills/skills/canary-fleet" ~/.claude/skills/canary-fleet
