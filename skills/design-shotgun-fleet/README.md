# design-shotgun-fleet

<p align="center">
  <img src="assets/banner.jpg" alt="design-shotgun-fleet" width="100%">
</p>

Orchestrate gstack design-shotgun under Orca: parallel variant generation, comparison board artifact, human pick.
...
ln -sfn "$(pwd)/agent-skills/skills/design-shotgun-fleet" ~/.claude/skills/design-shotgun-fleet
