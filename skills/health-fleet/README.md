...
<p align="center">
  <img src="assets/banner.jpg" alt="health-fleet" width="100%">
</p>

Parallel Orca workers for gstack health-style metrics: typecheck, lint, tests, dead code, dependency hygiene joined into one dashboard artifact.
...
ln -sfn "$(pwd)/agent-skills/skills/health-fleet" ~/.claude/skills/health-fleet
