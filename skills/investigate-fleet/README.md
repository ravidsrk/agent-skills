...
<p align="center">
  <img src="assets/banner.jpg" alt="investigate-fleet" width="100%">
</p>

Orchestrate gstack investigate methodology under Orca multi-role swarm: evidence, root cause, fix with tdd, review.
...
ln -sfn "$(pwd)/agent-skills/skills/investigate-fleet" ~/.claude/skills/investigate-fleet
