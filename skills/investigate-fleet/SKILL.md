---
name: investigate-fleet
description: >-
  Orchestrate gstack investigate methodology under Orca multi-role swarm: evidence, root
  cause, fix with tdd, review. Use when investigate fleet, systematic debugging
  autonomous, or gstack-style RCA. Complements diagnose-swarm.
license: MIT
compatibility: >-
...
# Investigate-Fleet — gstack root-cause on Orca
...
| Role | Duty |
|------|------|
| Evidence | reproduce, logs, bisect — gstack /investigate |
| RCA | written root cause (no fix yet) |
| Fix | /tdd + fix after RCA accepted |
| Review | build-blind |
