#!/usr/bin/env python3
"""preflight.py — hard preflight checks for a office-hours-async run.
...
def main(argv: list[str]) -> int:
    ...
    if args.base == default_branch:
        print(
            ...
            "promotion review. Create a dedicated integration branch (e.g. `<maintainer>/office-hours-async`) "
