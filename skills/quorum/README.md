...
Broadcast a self-contained ballot to @claude / @codex / @idle on a shared thread, reduce the replies to an auditable consensus table, and route splits to gate-steward as taste gates. JURY mode runs full independent candidates first (the model-jury pattern), with jurors never judging their own work.
