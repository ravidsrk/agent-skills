#!/usr/bin/env python3
"""preflight.py — hard preflight checks for a research-then-grill run.
...
def main(argv: list[str]) -> int:
    ...
    if args.base == default_branch:
        print(
            ...
            "promotion review. Create a dedicated integration branch (e.g. `<maintainer>/research-then-grill"
